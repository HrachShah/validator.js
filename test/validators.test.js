  ...
  it('should validate mailto URI', () => {
    test({
      ...
      valid: [
        ...
        'mailto:info@mail.com?subject=something=else',
        'mailto:info@mail.com?body=key=value',
      ...
      invalid: [
        ...
        'mailto:?subject=something&body=one&body=two',
        'mailto:?cc=first@example.com&cc=second@example.com',
        'mailto:?bcc=first@example.com&bcc=second@example.com',
        ...
        'mailto:hello@world.com?body',
        'mailto:hello@world.com?cc=valid@mail.com&bcc',
        'mailto:valid@gmail.com?subject=anything&body=nothing&cc=&bcc=&key=',
        'mailto:valid@gmail.com?=missing-key',
        'mailto:info@mail.com?subject=something&&cc=valid@mail.com',
